...
\begin{DoxyCode}
236 \{
237   \textcolor{keyword}{static} \textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{int} MAX\_STRING\_SIZE = 512;
238   \textcolor{keyword}{static} \textcolor{keyword}{const} \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{long} PRINT\_DELAY = 1000;
239   \textcolor{keyword}{static} \textcolor{keywordtype}{unsigned} \textcolor{keywordtype}{long} lastMillis = 0;
240   \textcolor{keywordtype}{char} jsonString[MAX\_STRING\_SIZE];
241 
242   \textcolor{comment}{/* Poll our IMU to update XYZ */}
243   \hyperlink{logging-device_8ino_a47be0262307aa023a1bda3d98986a16d}{orientation}.\hyperlink{class_logging_device_1_1_orientation_aad568a473f999c181abac46a4d832387}{pollIMU}();
244 
245   \textcolor{comment}{/* Parse NMEA codes into GPS object */}
246   \textcolor{keywordflow}{while} (\hyperlink{logging-device_8ino_aa2475f51bdc0f31d16d2916991d618d9}{serGPS}.available() > 0)
247   \{
248     \hyperlink{logging-device_8ino_a169c53997a7da1d0fb99aec1b4675ce8}{gps}.encode(\hyperlink{logging-device_8ino_aa2475f51bdc0f31d16d2916991d618d9}{serGPS}.read());
249   \}
250 
251   \textcolor{comment}{/* Print orientation and location information */}
252   \textcolor{keywordflow}{if} ((millis() - lastMillis) > PRINT\_DELAY)
253   \{
254     digitalWrite(\hyperlink{logging-device_8ino_ab4553be4db9860d940f81d7447173b2f}{LED\_PIN}, HIGH);
255 
256     \hyperlink{logging-device_8ino_a8d3614b16b26b9734d79e9f8f6695af3}{addOrientationToJSON}();
257     \hyperlink{logging-device_8ino_af1705fad6a6282b24379a174e18d4fe4}{addGPSToJSON}();
258     \hyperlink{logging-device_8ino_a9e4931f452cd25dfff67d41e7c9c0efb}{addTimeToJSON}();
259 
260     \textcolor{comment}{/* Print our json object into a string */}
261     \hyperlink{logging-device_8ino_a5eebfb3b76a83174d0f5d032d1f6bfb7}{mainJSON}.printTo(jsonString, MAX\_STRING\_SIZE);
262 
263     \textcolor{comment}{/* Log JSON to the microSD */}
264     \hyperlink{logging-device_8ino_a40059244119c00baa1b841119cfd1b2e}{storage}.\hyperlink{class_logging_device_1_1_storage_a044a17325b2917afca49aa19ddb488f6}{saveToFile}(jsonString, \textcolor{keyword}{true});
265 
266     \textcolor{comment}{/* Print to our bluetooth module */}
267     \hyperlink{logging-device_8ino_ad1e6e6f6fc813b305067b9e1b0777ea6}{BT\_SERIAL}.println(jsonString);
268 
269     lastMillis = millis();
270     digitalWrite(\hyperlink{logging-device_8ino_ab4553be4db9860d940f81d7447173b2f}{LED\_PIN}, LOW);
271   \}
272 \}
\end{DoxyCode}
